...
export default function Header() {
  ...
  return (
    <>
      ...
      <header className="fixed  top-0 left-0 right-0 h-24 mb-10 bg-background border-b border-border z-50 flex items-center justify-between px-4  ">
      ...
      <div className="w-full   flex items-center justify-between p-2 ">
          <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="28" height="28" data-testid="brand-icon-icon" aria-hidden="true" focusable="false" className="logo-icon">
            <path fillRule="evenodd" d="M35 0H5C2.24 0 0 2.24 0 5v30c0 2.76 2.24 5 5 5h30c2.76 0 5-2.24 5-5V5c0-2.76-2.24-5-5-5Z" fill="#ff2b85"></path>
